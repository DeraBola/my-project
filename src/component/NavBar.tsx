...
export default function NavBar() {
  ...
  return (
    <div className="border w-full h-[3rem] flex justify-between z-20 bg-[#0E0E0E] fixed top-0 left-0 items-center px-2 lg:px-8">
      <div className="flex z-20 transition-all  bg-[#8b3636] w-[80%] justify-start items-center gap-4">
      ...
      {showMenu? <CloseSquare className="block lg:hidden relative z-20" size={40} onClick={() => setShowMenu(!showMenu) } /> : <Menu className="block lg:hidden relative z-20" size={32} onClick={() => setShowMenu(!showMenu)} /> }
